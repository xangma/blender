 ...
 */
typedef struct OceanSplitSupport {
 ...
 */
typedef struct OceanSplitResult {
...
typedef struct OceanSplitRuntimeLevel {
  int size_x;
  int size_y;
  float wavelength;
  float cumulative_disp_variance[3];
  float cumulative_slope_moment[3];
} OceanSplitRuntimeLevel;

typedef struct OceanSplitRuntimeReadScope {
